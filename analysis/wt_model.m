...
model = readCbModel('../models/mat/iWFL_1372.mat');
% model = readCbModel('../models/mat/iECW_1372.mat');
...
model = changeRxnBounds(model,'EX_o2_e',-1000,'l'); % Set maximum oxygen uptake
